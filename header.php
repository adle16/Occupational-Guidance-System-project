			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="main.php">CareerMap</a>
					</div>
					<!-- /Logo -->
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="./html/choicestp.html">After 10th Prediction</a>
                                <a href="courses.php">Courses</a>
                                <a href="http://127.0.0.1/php%20CAREERLY/blog.php">Career Prediction</a>
				...
				<nav id="nav">
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="templates/hometest.html">Career Prediction</a>
                                <a href="courses.php">Courses</a>
